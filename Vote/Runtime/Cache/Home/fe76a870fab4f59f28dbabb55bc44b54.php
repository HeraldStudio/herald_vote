...
<div>
	<div id="carousel-example-captions" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="item">
				<img class="item-img" alt="bg-1" src="/herald_vote/Public/Images/bg-1.jpg">
			...
			<div class="item active">
				<img class="item-img" src="/herald_vote/Public/Images/bg-2.jpg">
					<div class="carousel-caption">
			...
			<div class="item">
				<img class="item-img" src="/herald_vote/Public/Images/bg-3.jpg">
					<div class="carousel-caption">
