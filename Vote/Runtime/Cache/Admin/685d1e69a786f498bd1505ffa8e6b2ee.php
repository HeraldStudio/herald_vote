										  	...
										  	<div class="input-group">
											    <input type="text" name="vote_item_name[1]" class="form-control" id="1" placeholder="选项1">
											  	...
											  	<div class="input-group-btn">
												    <button type="button" class="btn btn-default uploadevent" tabindex="-1" data-toggle="modal" data-target="#model_upload" id="add_attach_1">添加附件</button>
												  </div>
											  </div>
											  <div class="input-group">
											    <input type="text" name="vote_item_name[2]" class="form-control" id="2" placeholder="选项2">
											  	...
											  	<div class="input-group-btn">
												    <button type="button" class="btn btn-default uploadevent" tabindex="-1" data-toggle="modal" data-target="#model_upload" id="add_attach_2">添加附件</button>
												  </div>
											  </div>
											  <div class="input-group">
											    <input type="text" name="vote_item_name[3]" class="form-control" id="3" placeholder="选项3">
											  	...
											  	<div class="input-group-btn">
												    <button type="button" class="btn btn-default uploadevent" tabindex="-1" data-toggle="modal" data-target="#model_upload" id="add_attach_3">添加附件</button>
												  </div>
											  </div>
											  <div class="input-group">
											    <input type="text" name="vote_item_name[4]" class="form-control" id="4" placeholder="选项4">
											  	...
											  	<div class="input-group-btn">
												    <button type="button" class="btn btn-default uploadevent" tabindex="-1" data-toggle="modal" data-target="#model_upload" id="add_attach_4">添加附件</button>
												  </div>
											  </div>
										  </div>
